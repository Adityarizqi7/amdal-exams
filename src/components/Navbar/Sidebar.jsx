...
export default function Topbar() {
    ...
    const SideBarTheme = createTheme({
        ...
        "item": {
            "base": "flex items-center justify-center rounded-lg p-2 text-base font-normal text-white hover:bg-green-800/80",
                ...
                <SidebarItems>
                    <SidebarItemGroup>
                        ...
                        <SidebarCollapse
                            label="Pengguna"
                        >
                            <SidebarItem href="/dashboard/users" className="">Daftar Pengguna</SidebarItem>
                        ...
                        <SidebarCollapse
                            label="Pertanyaan"
                        >
                            <SidebarItem className="" href="/dashboard/questions">Daftar Pertanyaan</SidebarItem>
